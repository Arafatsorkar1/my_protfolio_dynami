        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="form-horizontal p-t-20" action="{{route('portfolio.update',['id'=>$portfolio->id])}}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="title" value="{{$portfolio->title}}" placeholder="Project Title ">
                            </div>
                        </div>

                        <div class="form-group row">
                            <label for="exampleInputEmail3" class="col-sm-3 control-label">Your Details<span class="text-danger">*</span></label>
                            <div class="col-sm-9">
                                <textarea  class="form-control" name="details"  placeholder="Details">{{$portfolio->details}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <img src="{{asset($portfolio->image)}}" alt="{{$portfolio->title}}" width="60" height="60">
                            </div>
                        </div>
